    ...
    */
    {
        $(document).ready(function () {
            ...
            if(lang == "fr"){
                entry_title = "La page ne peut pas être trouvée."
                page_content = "Il semble que rien n’a été trouvé à cet emplacement."
            }else if(lang == "es"){
                entry_title = "No se ha podido encontrar la página."
                page_content = "Parece que no se ha encontrado nada en esta ubicación."
            }else if(lang == "en"){
                entry_title = "The page can’t be found."
                page_content = "It looks like nothing was found at this location."
            }else if(lang == "pt"){
                entry_title = "A página não pode ser encontrada."
                page_content = "Parece que nada foi encontrado neste local."
            }else{
                entry_title = "The page can’t be found."
                page_content = "It looks like nothing was found at this location."
            }

            document.getElementById("entry-title").innerText =entry_title;
            document.getElementById("page-content").innerText =page_content;
