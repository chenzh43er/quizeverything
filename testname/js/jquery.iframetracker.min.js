/*! jquery.iframetracker v2.1.0 | https://github.com/vincepare/iframeTracker-jquery | Copyright (c) 2013-2018 Vincent Paré | Licensed Apache-2.0 */ !(function (
  e,
  r
) {
  ...
  !(function (e) {
    (e.fn.iframeTracker = function (r) {
      ...
      (e.iframeTracker = {
        ...
        track: function (r, t) {
          (t.target = r),
            e.iframeTracker.handlersList.push(t),
            e(r)
              .bind(
                "mouseover",
                {
                ...
                e.iframeTracker.mouseoverListener
              )
              .bind(
                "mouseout",
                {
        ...
        untrack: function (r) {
          if ("function" == typeof Array.prototype.filter) {
            e(r).each(function (r) {
              e(this)
                .unbind("mouseover", e.iframeTracker.mouseoverListener)
                .unbind("mouseout", e.iframeTracker.mouseoutListener);
            });
            var t = function (e) {
              return null !== e;
            };
            for (var i in this.handlersList) {
              for (var o in this.handlersList[i].target)
                -1 !== e.inArray(this.handlersList[i].target[o], r) &&
                  (this.handlersList[i].target[o] = null);
              (this.handlersList[i].target =
                this.handlersList[i].target.filter(t)),
                0 === this.handlersList[i].target.length &&
